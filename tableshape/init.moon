...
-- Create a function that validates arguments before calling the wrapped function
...
{ :check_shape, :types, :is_type, :BaseType, :FailedTransform, :with_args, VERSION: "2.6.0" }
